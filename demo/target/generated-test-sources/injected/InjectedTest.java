...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\dev\\Java_Dev\\Hello-world-plugin\\hello-world-pipeline\\demo");
    parameters.put("artifactId","demo");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","C:\\dev\\Java_Dev\\Hello-world-plugin\\hello-world-pipeline\\demo\\target\\classes");
    parameters.put("testOutputDirectory","C:\\dev\\Java_Dev\\Hello-world-plugin\\hello-world-pipeline\\demo\\target\\test-classes");
